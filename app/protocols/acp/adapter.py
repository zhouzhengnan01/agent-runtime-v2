...
def _template_runtime_options(app_template: AppTemplate | None) -> dict[str, Any]:
    ...
    # App templates provide model/runtime defaults. Skills and workflows must be
    # selected explicitly per turn, otherwise normal chat would unexpectedly run
    # an application workflow and trigger input_required prompts.
    return payload
