...
docker_run() {
  ...
  run_args+=(
    ...
    -e JETLINKS_TRAINING_MAX_RUNNING="${JETLINKS_TRAINING_MAX_RUNNING}"
    -e JETLINKS_TRAINING_MAX_WAITING="${JETLINKS_TRAINING_MAX_WAITING}"
...
export JETLINKS_TRAINING_MAX_RUNNING JETLINKS_TRAINING_MAX_WAITING
pid="$("${PYTHON_BIN}" - <<'PY'
