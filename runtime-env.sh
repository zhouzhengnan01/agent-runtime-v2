...
JETLINKS_TRAINING_MAX_RUNNING="${JETLINKS_TRAINING_MAX_RUNNING:-10}"
JETLINKS_TRAINING_MAX_WAITING="${JETLINKS_TRAINING_MAX_WAITING:-10}"
...
JETLINKS_REVIEW_MAX_CONCURRENCY="${JETLINKS_REVIEW_MAX_CONCURRENCY:-10}"
